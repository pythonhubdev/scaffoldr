...
def apply_wave_effect(
    text: str, frame: int, wave_speed: float = 0.3, wave_amplitude: float = 0.5
) -> Text:
    ...
    try:
        ...
        for frame in range(frames):
            ...
            for line in BANNER_ART:
                animated_line = apply_wave_effect(
                    line, frame, wave_speed=0.4, wave_amplitude=0.8
                )
            ...
            animated_tagline = apply_wave_effect(
                TAGLINE, frame + 10, wave_speed=0.2, wave_amplitude=0.3
            )
